...
para consolidar el terminado de la tablilla es critico realizar un diseño de PCB adecuado, donde se indicaran las vias, perforaciones, para esamblar los componentes e integrados, asi como las conexiones (pistas) fisicas entre los mismos. La organizacion de los componentes es vital para asegurar conexiones que aprovechen al maximo el espacio sin llegar a favorecer cortos, antenas o sobrelapaciones entre las rutas; el software de Kicad proporciona diversas hermientas para lograr un buen diseño del PCB, ofrciendo una interfaz visual donde se muestra las conexiones entre las terminales de los elementos, cuyas pistas se pueden trazar de forma dinamica con una ayuda del software para restringir ciertas rutas; por otro lado nos permite ademas verificar las conexiones y errores de red en la tablilla. Por esto queda claro como m¿metodos como este pueden llegar a suplantar a la fomra tradicional de planchado de tablillas, haciendo de la precision, eficiencia y acabado aspectos controlados gracias al la ayuda del software en combinacion con la impresion CNC.

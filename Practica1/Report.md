...
Con esta practica queda claro cuales circuitos basicos para una tarjeta, microntrolador, y como es que se construyen a traves de los diversos componentes y herramientas que el software de Kicad proporciona, comprendiendo como apartir de un esquemtatico constituido por simbolos que representan un elemento fisico en asociacion a un componente electronico.La capacidad del software al integrar una extensa variedad de librerias deja una gran libeertad en la crecion de los esquematicos. Por otro lado a pesar de haberse logrado un tarjeta simple los requerimientos fueron suficientes para practicar el editor del software asi como la inclusion y manejo de librerias para la asignacion de las huellas hacia los simbolos; creo que esta practica ha sido de gran ayuda orientando nuestra perspectiva sobre la manera para la construccion de los esquematicos.
